...
const RelatedBlog = () => {
  ...
  return (
    <div className='bg-slate-100 m-5 p-7 rounded-md h-2/4 overflow-hidden'>
        <h3 className='text-3xl font-medium pt-8 px-8 pb-5 text-[#ff4221]'>Latest Blog </h3>
            ...
            blog.length > 0 ? (<div className='space-y-4 mt-5'>
                  {
                    blog.map((blog) => (
                        ...
                        className='flex flex-col sm:flex-row gap-4 shadow-sm '>
                           ...
                           <div className='mb-2'>
                            <h4 className='font-medium text-xl text-[#ff4221]'>{blog.title.substring(0, 50)}....</h4>
                            
                           </div>
                        </a>
                    ))
                  }
             </div>) :(<div className='p-8 text-[#ff4221]'>No related blogs found</div>)
